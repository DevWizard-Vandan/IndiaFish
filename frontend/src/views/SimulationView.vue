...
import { closeSimulationEnv, getEnvStatus, getSimulation, stopSimulation } from '../api/simulation'
...
const handleNextStep = (params = {}) => {
  ...
  if (params.scenarioId) routeParams.query.scenarioId = params.scenarioId
  if (params.customVariable) routeParams.query.customVariable = params.customVariable
  if (params.agentCount) routeParams.query.agentCount = params.agentCount
...
const checkAndStopRunningSimulation = async () => {
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      addLog('Detected a running simulation environment. Closing it before setup...')
      try {
